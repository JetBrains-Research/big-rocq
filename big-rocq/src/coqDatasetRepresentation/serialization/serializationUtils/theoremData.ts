...
} from "./codeElementPositions";
import { SerializedGoal, deserializeGoal, serializeGoal } from "./goalParser";
...
export class TheoremData {
    ...
    constructor(
        ...
        this.name = sourceTheorem.name;
        this.proof = sourceTheorem.proof;
    }
}
...
export function deserializeProofStep(
...
export function serializeProofStep(proofStep: ProofStep): SerializedProofStep {
    return {
        text: proofStep.text,
