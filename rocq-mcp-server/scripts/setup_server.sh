...
filepath="/usr/local/bin/rocq-servers"
...
printf "\e[33mThe command 'rocq-servers' has been created! \033[0m✅\n"
printf "\033[0;32mNow, you can run 'rocq-servers' from any location.\033[0m\n"